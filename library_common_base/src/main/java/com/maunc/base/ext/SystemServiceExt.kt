...
fun showSoftInputKeyBoard(
    ...
    editText.postDelayed({
        ...
        val inputManger = BaseApp.app.inputMethodManager
...
fun forceHideKeyboard(view: View) {
    val imm = BaseApp.app.inputMethodManager ?: return
    // 关闭所有激活的输入法窗口
