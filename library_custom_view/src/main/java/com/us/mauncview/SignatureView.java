...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            penSize = typedArray.getDimension(R.styleable.SignatureView_penSize, 40.0f);
    ...
    private void drawLine(final float lastWidth, final float currentWidth, final float velocity) {
