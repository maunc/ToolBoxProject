...
//import com.jidouauto.market.api.data.ApnHelper;
...
//        ApnHelper apnHelper = new ApnHelper(FileDownloadHelper.getApnServiceProvide());
        if (FileDownloadLog.NEED_LOG) {
            FileDownloadLog.d(this, "createDefaultConnectionCreator "
                    + "isApn2UseOEMNetwork $isApn2UseOEMNetwork");
        }
//        if (apnHelper.isApn2UseOEMNetwork()) {
//            return new FileDownloadUrlApnConnection.Creator();
//        } else {
