...
public class SwitchButtonView extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.SwitchButtonView);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.SwitchButtonView_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.SwitchButtonView_kswThumbColor);
            margin = ta.getDimension(R.styleable.SwitchButtonView_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.SwitchButtonView_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.SwitchButtonView_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.SwitchButtonView_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.SwitchButtonView_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.SwitchButtonView_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.SwitchButtonView_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.SwitchButtonView_kswThumbRadius, thumbRadius);
            backRadius = ta.getDimension(R.styleable.SwitchButtonView_kswBackRadius, backRadius);
            backDrawable = ta.getDrawable(R.styleable.SwitchButtonView_kswBackDrawable);
            backColor = ta.getColorStateList(R.styleable.SwitchButtonView_kswBackColor);
            thumbRangeRatio = ta.getFloat(R.styleable.SwitchButtonView_kswThumbRangeRatio, thumbRangeRatio);
            animationDuration = ta.getInteger(R.styleable.SwitchButtonView_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.SwitchButtonView_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.SwitchButtonView_kswTintColor, tintColor);
            textOn = ta.getString(R.styleable.SwitchButtonView_kswTextOn);
            textOff = ta.getString(R.styleable.SwitchButtonView_kswTextOff);
            textThumbInset = ta.getDimensionPixelSize(R.styleable.SwitchButtonView_kswTextThumbInset, 0);
            textExtra = ta.getDimensionPixelSize(R.styleable.SwitchButtonView_kswTextExtra, 0);
            textAdjust = ta.getDimensionPixelSize(R.styleable.SwitchButtonView_kswTextAdjust, 0);
            ta.recycle();
        }
