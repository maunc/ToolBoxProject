...
public class BubbleSeekBar extends View {
    ...
    private final int mTrackSize; // height of right-track(on the right of thumb)
    ...
    private final int mSectionTextSize; // text size of section-text
    private final int mSectionTextColor; // text color of section-text
    @TextPosition
    ...
    private final int mThumbTextColor; // text color of progress-text
    private boolean isShowProgressInFloat; // show bubble-progress in float or not
    private final boolean isTouchToSeek; // touch anywhere on track to quickly seek
    private final boolean isSeekStepSection; // seek one step by one section, the progress is discrete
    private boolean isSeekBySection; // seek by section, the progress may not be linear
    private final long mAnimDuration; // duration of animation
    private boolean isAlwaysShowBubble; // bubble shows all time
    private final long mAlwaysShowBubbleDelay; // the delay duration before bubble shows all the time
    private final  boolean isHideBubble; // hide bubble
    private final  boolean isRtl; // right to left

    private int mBubbleColor;// color of bubble
    private final int mBubbleTextSize; // text size of bubble-progress
    private final int mBubbleTextColor; // text color of bubble-progress
    ...
    private final int mTextSpace; // space between text and track
    ...
    private final int[] mPoint = new int[2];
